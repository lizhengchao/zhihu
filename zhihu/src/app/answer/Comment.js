        ...
        return (
            <div className={style.comment}>
                <div className={style.top}>
                    <div className={style.commentCount}>{this.status.count}条评论</div>
                    <div className={style.sortType}>{this.status.sortType === 0 ? '按时间排序' : '按默认排序'}</div>
                </div>
                <div className={style.comments}>
                    {buildComments(this.comments)}
                </div>
            </div>
        );
    }
